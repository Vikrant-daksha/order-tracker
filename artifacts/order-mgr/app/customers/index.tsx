    ...
    return dbCustomers
      .map((c) => {
        ...
        return {
          ...
          lastOrderDate: custOrders.reduce(
        ...
        renderItem={({ item }) => (
          ...
          >
            <View style={[styles.avatar, { backgroundColor: colors.accent }]}>
              <Text style={[styles.avatarText, { color: "#C06070" }]}>
            ...
            <View style={{ flex: 1, gap: 3 }}>
              ...
              {item.igHandle ? (
                <Text
                  style={[styles.contact, { color: colors.mutedForeground }]}
                >
                  @{item.igHandle}
                </Text>
              ) : null}
              ...
              <View style={styles.statsRow}>
                ...
                <Text
                  style={[styles.statDot, { color: colors.mutedForeground }]}
                >
                  ·
                </Text>
                <Text
                  style={[styles.statText, { color: colors.mutedForeground }]}
                >
                  ₹{item.totalSpent.toFixed(2)} spent
                </Text>
              </View>
            </View>
            <Feather
